{
  ...
  extras = stdenv.mkDerivation {
    ...
    name = "aura-extras${lib.optionalString debug "-debug"}";
  ...
  plugin = stdenv.mkDerivation {
    inherit cmakeBuildType;
    name = "aura-qml-plugin${lib.optionalString debug "-debug"}";
    src = lib.fileset.toSource {
      root = ./..;
...
in
  stdenv.mkDerivation {
    ...
    pname = "aura-shell${lib.optionalString debug "-debug"}";
    src = ./..;
    ...
    cmakeFlags =
      [
        ...
        (lib.cmakeFeature "INSTALL_QSCONFDIR" "${placeholder "out"}/share/aura-shell")
      ]
      ++ cmakeVersionFlags;
    ...
    postInstall = ''
      ...
      chmod 755 $out/share/aura-shell/assets/wrap_term_launch.sh
    '';
    ...
    meta = {
      ...
      homepage = "https://github.com/CjLogic/Aura-Shell";
      license = lib.licenses.gpl3Only;
      mainProgram = "aura-shell";
    };
  }
